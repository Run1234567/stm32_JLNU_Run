...
/*
 * =================================================================================
 * [PART 2] 高精度算法 - Mahony/Quaternions (6-Axis Fusion)
 * =================================================================================
 * 特点：使用四元数解算，无万向节锁，动态跟随性好，适合无人机、3D姿态。
 * 原理：利用加速度计修正陀螺仪积分误差 (PI控制器)。
 */
...
/*
 * _  _   ___   _____   ___   ___    _  _     ___   __  __   _   _ 
 * | || | | __| |_   _| |_ _| / _ \  | \| |   |_ _| |  \/  | | | | |
 * | __ | | _|    | |    | | | (_) | | .` |    | |  | |\/| | | |_| |
 * |_||_| |___|   |_|   |___| \___/  |_|\_|   |___| |_|  |_|  \___/ 
 * * >> 6-AXIS MOTION TRACKING SYSTEM INITIALIZED...
 * >> SYSTEM READY.
 */
...
/*
 * =================================================================================
 * [PART 1] 轻量级算法 - 互补滤波 (Complementary Filter)
 * =================================================================================
 * 特点：计算极快，代码极简，适合平衡车、简单的水平检测。
 * 缺点：抗震性一般，Z轴(Yaw)无法修正漂移。
 */
